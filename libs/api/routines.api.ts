...
): Promise<ApiResponse<UpdateRoutineResponseDto>> => {
  try {
    const response = await axiosInstance.put<
      ApiResponse<UpdateRoutineResponseDto>
...
export const deleteRoutine = async (
  id: number
): Promise<ApiResponse<DeleteRoutineResponseDto>> => {
  try {
    const response = await axiosInstance.delete<
      ApiResponse<DeleteRoutineResponseDto>
    >(`/api/routines/${id}`);
    return response.data;
  } catch (error) {
...
export const getDashboardRoutines = async (
  ...
  try {
    ...
    const response = await axiosInstance.get<
      ApiResponse<DashboardRoutineDto[]>
    >(url);
    return response.data;
  } catch (error) {
