...
import { CreateRoutineCompletionUseCase } from "../../../backend/routine-completions/applications/usecases/CreateRoutineCompletionUseCase";
...
export async function POST(req: NextRequest) {
  try {
    ...
    const createRoutineCompletionUseCase = new CreateRoutineCompletionUseCase(
      routineCompletionsRepository
    );

    const result = await createRoutineCompletionUseCase.execute({
